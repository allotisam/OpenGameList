...
export class ItemService {
    ...
    // calls the [GET] /api/items/GetLatest/{n} WebApi method to retrieve the latest items.
    ...
    // calls the [GET] /api/items/GetRandom/{n} Web Api method to retrieve random items.
